...
// Ya sea inserción o modificación de datos
   //  <form name="formulario_registro" id="formulario_registro"> desde jsp
    ...
    $(document).on("submit", "#formulario_registro", function (e) {
        ...
        var datos = $("#formulario_registro").serialize();  //para serializar los datos del formulario y se guardan en la variable datos
...
function cargarTabla(estado = 1) {
    ...
    console.log("datos "+datos.consultar_datos);//para aceder al objeto para ver los datos que lleva el arreglo
    ...
    $.ajax({
        ...
        url: "RegAutor",
        data: datos
    }).done(function (json) {//se recibe un objeto 
        Swal.close();
        ...
        if (json[0].resultado === "exito") {
            ...
            $("#tabla_autores").DataTable({
                "language": {//Para imprimir de forma correcta los datos
